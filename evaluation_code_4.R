...
WriteCSVToFolder(data_toplot, "dx_daily_data_for_fig2.csv")
...
WriteCSVToFolder(data_toplot_weekly, "dx_weekly_data_for_figS1.csv")
...
WriteCSVToFolder(data_toplot, "onset_daily_data_for_figS2.csv")
...
WriteCSVToFolder(data_toplot_weekly_onset, "onset_weekly_data_for_figS3.csv")
...
p_onset
ggsave(filename="evaluation_figure_S2.png", path=dataset_path, plot=p_onset, height = 8, width = 10, unit = "in")

p_onset_weekly
ggsave(filename="evaluation_figure_S3.png", path=dataset_path, plot=p_onset_weekly, height = 8, width = 10, unit = "in")
