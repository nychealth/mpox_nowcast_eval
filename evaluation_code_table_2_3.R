...
# This code populates:
# Table 2 (descriptive lags from diagnosis to diagnosis report and onset to onset report)
# Table 3 (summary of missingness in onset date)

#Set paths and source supporting files
R<- "" #update code folder path here, this should be the folder containing all 6 source code files
...
WriteCSVToFolder(table2_towrite, "evaluation_table_2_results.csv")
...
write.csv(all_final, file=file.path(dataset_path,"evaluation_table_3_results.csv"))
